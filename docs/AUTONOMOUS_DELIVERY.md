...
Existing tag-driven Docker Hub workflow is canonical; version/tag creation remains governed by the project release process.

## Docker contract

Requires DOCKERHUB_USERNAME and DOCKERHUB_TOKEN in the production environment.
